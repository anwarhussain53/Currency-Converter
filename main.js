...
var getRates = function() {
	...
	$.ajax({
			url: "http://openexchangerates.org/latest.json?app_id=a4600493f37f4d52a5bd51a7dfc86f7c",
			dataType: "jsonp",
			type: "GET",
			processData: true,
...
var populateSelectMenus = function() {
	...
	$.ajax({
			url: "http://openexchangerates.org/currencies.json?app_id=a4600493f37f4d52a5bd51a7dfc86f7c",
			dataType: "jsonp",
			type: "GET",
			processData: true,
			contentType: "application/json",
